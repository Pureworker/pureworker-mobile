...
///
///
const HelloWorldView = ({route, navigation}: any) => {
  ...
  const initBackgroundGeolocation = async () => {
    ...
    subscribe(
      BackgroundGeolocation.onLocation(
        location => {
          ...
          axios
            .post('https://api.pureworker.com/api/location2', {
    ...
    subscribe(
      BackgroundGeolocation.onHttp(event => {
        ...
        axios
          .post('https://api.pureworker.com/api/location2', {
            long: `http${event?.longitude}`,
            lat: `http${event?.latitude}`,
          })
          .then(response => {
            console.log(
              'BACKGROUND:Location sent successfully:',
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomToolbar}>
        <View style={{justifyContent: 'center'}}>
          ...
          /> */}
          <TouchableOpacity onPress={onClickGetCurrentPosition}>
            <Text style={{color: 'black'}}> navigate-sharp</Text>
          </TouchableOpacity>
        </View>
        <View style={{flex: 1}} />
        <View style={{justifyContent: 'center'}}>
          ...
          <TouchableOpacity onPress={onClickClear}>
            <Text style={{color: 'black'}}> Trash-Icon</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
